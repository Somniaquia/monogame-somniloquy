namespace Somniloquy {
    ...
    public class SpriteSheet {
        ...
        public SpriteSheet(Point frameSize) {
            ...
            RawSpriteSheet = new Texture2D(SQ.GD, frameSize.X, frameSize.Y);
        ...
        private void ExpandTexture(int additionalHeight) {
            Texture2D expandedTexture = new(SQ.GD, RawSpriteSheet.Width, RawSpriteSheet.Height + additionalHeight);
        ...
        public int GetLatestFrame() {
            return RawSpriteSheet.Height / TileLayer2D.TileLength - 1;
        }

        public int NewFrame() {
            ExpandTexture(TileLayer2D.TileLength);
            return RawSpriteSheet.Height / TileLayer2D.TileLength - 1;
        }
