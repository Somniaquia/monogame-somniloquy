namespace Somniloquy {
    ...
    public class Sprite {
        ...
        public void Draw(Rectangle destination, float opacity = 1f) {
            SQ.SB.Draw(SpriteSheet.RawSpriteSheet, destination, new Rectangle(new Point(0, CurrentAnimation.FrameIndices[CurrentAnimationFrame] * SpriteSheet.FrameSize.Y), SpriteSheet.FrameSize), Color.White * opacity);
        }
    }
}